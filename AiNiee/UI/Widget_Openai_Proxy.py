...
from .Widget_Openai_Proxy_A import Widget_Openai_Proxy_A
from .Widget_Openai_Proxy_B import Widget_Openai_Proxy_B
...
class Widget_Openai_Proxy(QFrame):  # Openai代理账号主界面
    def __init__(self, text: str, parent=None):  # 构造函数，初始化实例时会自动调用
        ...
        self.A_settings = Widget_Openai_Proxy_A(
            "A_settings", self
        )  # 创建实例，指向界面
        self.B_settings = Widget_Openai_Proxy_B(
            "B_settings", self
        )  # 创建实例，指向界面
